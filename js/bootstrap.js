...
<li class=" menu__item"><a class="menu__link" href="programs.html">Программы</a></li>
...
if (document.querySelector(".tree-list-pad") != null) {
    ...
    document.querySelector(".tree-list-pad").innerHTML = `
        <li>
        <a href="pos.html">
            <p><i class="fa fa-caret-right" aria-hidden="true"></i> POS моноблоки</p>
        </a>
        </li>
        <li>
...
if (document.querySelector(".w3_short") != null) {
    if (document.querySelector(".w3_short").children[2] != null) {
        if (document.querySelector(".w3_short").children[2].children != null) {
            let categoryText = document.querySelector(".w3_short").children[2].children.length > 1 ? document.querySelector(".w3_short").children[2].children[0].innerHTML : document.querySelector(".w3_short").children[2].innerHTML
        ...
        for (let j = 0; j < data5.length; j++) {
            ...
            if (mainLengthLink == data5[j].link) {
                ...
                mainLength[index].children[0].innerHTML += `
                    <div class="search-price-container2"><span class="search-price">${formatter(data5[j].price)} тг</span></div>
                `

                mainLength[index].children[1].innerHTML =
                    `
                        <p><span class="item-price-indicator_second">Цена:<br> </span><span class="item_price_second">${formatter(data5[j].price)} тг </span></p>
...
function dynamicallyLoadScript() {
   ...
   ym(83745763, "init", {
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/61448a8bd326717cb681fb5b/1ffprqcu1';
    s1.charset='UTF-8';
...
if (document.querySelectorAll(".col-md-8, .single-right-left, .simpleCart_shelfItem") != null) {
    ...
    for (let index = 0; index < data5.length; index++) {
        ...
        if (element.link === filename || element.link.split('.').slice(0, -1).join('.') === filename) {
            ...
            console.log(element.link.split('.').slice(0, -1).join('.'));
            ...
            path[1].children[3].children[1].innerHTML = `${formatMoney(element.price)} тг`;
